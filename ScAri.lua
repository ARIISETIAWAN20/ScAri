--[[
    Roblox Speed & Infinite Jump Script
    Features:
...
SpeedSlider:GetPropertyChangedSignal("Value"):Connect(function()
    local percent = (SpeedSlider.Value - SpeedSlider.MinValue) / (SpeedSlider.MaxValue - SpeedSlider.MinValue)
    SliderFill.Size = UDim2.new(percent, 0, 1, 0)
    SpeedLabel.Text = "Speed: " .. math.floor(SpeedSlider.Value)
...
JumpToggle.MouseButton1Click:Connect(function()
    ...
    if jumpEnabled then
        ...
        UIS.InputBegan:Connect(function(input, gameProcessed)
            if not gameProcessed and input.KeyCode == Enum.KeyCode.Space and jumpEnabled then
